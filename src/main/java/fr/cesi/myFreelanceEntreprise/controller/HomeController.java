...
public class HomeController {
    ...
    // ToDo : 1. La barre de progression représente le chiffre d’affaires hors taxe encaissé cette année. Un auto-entrepreneur ne peux encaisser plus de 70000 euros par an sans changer de statut.


    //ToDo : 1. Lorsqu’une facture est payée, elle vient augmenter la barre de progression sur la page d’accueil du site.
